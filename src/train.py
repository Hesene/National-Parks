...
#                'gpu_use_dp':True,
                ...
                'learning_rate': 0.01,
                'num_leaves': 37,
                'colsample_bytree': 0.899321807026306,
                'subsample': 0.123456115376095,
                'max_depth': 7,
                'reg_alpha': 1.53342026789212,
                'reg_lambda': 1.25514924005287,
                'min_split_gain': 0.157901349986747,
                'min_child_weight': 1.94436964166614,
                'min_data_in_leaf': 1,
                'verbose': -1,
                'seed':int(2**n_fold),
